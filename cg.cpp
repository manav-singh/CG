...
char xd = 'r', yd = 'u';
void printString(const char print[], int Stringlenght, double stringX, double stringY, int size)
{
...
void Display()
{
    ...
    else if (gameOver == 10)
    {
        ...
        printString("Developer : Manav Singh Kainth", strlen("        Manav Singh Kainth"), -1.0, 0.48, 60);
        printString("Submitted to : Jyoti Mam",
        strlen("Submitted to : Jyoti Mam"), -1.0, 0.35, 60);        
        ...
        printString("5) Space : Fire", strlen("5) Space : Fire"), -0.63, -0.3,60);
